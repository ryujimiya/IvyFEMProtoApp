...
namespace IvyFEMProtoApp
{
    ...
    {
        public void FluidRANSDropletTDProblem1(MainWindow mainWindow)
        {
            //////////////////////////////////////////////////////
            // dropletの位置
            ...
            */
            ...
            IList<ConstFieldFixedCad> forceFixedCadsEp = new List<ConstFieldFixedCad>();
            {
                var fixedCadDatas = new[]
                {
                    ...
                    new { CadId = (uint)4, CadElemType = CadElementType.Vertex,
                        FixedDofIndexs = new List<uint> { 0, 1 }, Values = new List<double> { 0.0, 0.0 } },
                };
            ...
            }
            {
                ...
                forceFixedCadsEp.Add(fixedCads[0] as ConstFieldFixedCad);
                forceFixedCadsEp.Add(fixedCads[1] as ConstFieldFixedCad);
                forceFixedCadsEp.Add(fixedCads[2] as ConstFieldFixedCad);
                forceFixedCadsEp.Add(fixedCads[3] as ConstFieldFixedCad);
            }
            ...
            for (int iTime = 0; iTime <= 100; iTime++)
            {
                ...
                else
                {
                    ...
                    {
                        var fixedCads = world.GetFieldFixedCads(epQuantityId);
                        foreach (var forceFixedCad in forceFixedCadsEp)
                        {
                            fixedCads.Remove(forceFixedCad);
                        }
                    }
                ...
                var FEM = new FluidRANSDroplet2DRKTDFEM(world, dt,

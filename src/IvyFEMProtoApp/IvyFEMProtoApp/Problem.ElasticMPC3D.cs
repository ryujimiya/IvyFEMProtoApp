...
namespace IvyFEMProtoApp
{
    ...
    {
        public void ElasticMultipointConstraint3DTDProblem(MainWindow mainWindow, bool isStVenant)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            Cad3D cad = new Cad3D();
            {
                ...
                pts.Add(new OpenTK.Vector3d(-1.0 / Math.Sqrt(2.0), 0.0, 1.0 / Math.Sqrt(2.0)));
                pts.Add(new OpenTK.Vector3d(0.0, 0.0, 0.0));
                pts.Add(new OpenTK.Vector3d(0.0, 1.0, 0.0));
                pts.Add(new OpenTK.Vector3d(-1.0 / Math.Sqrt(2.0), 1.0, 1.0 / Math.Sqrt(2.0)));
                pts.Add(new OpenTK.Vector3d(4.0 / Math.Sqrt(2.0), 0.0, 6.0 / Math.Sqrt(2.0)));
                pts.Add(new OpenTK.Vector3d(5.0 / Math.Sqrt(2.0), 0.0, 5.0 / Math.Sqrt(2.0)));
                pts.Add(new OpenTK.Vector3d(5.0 / Math.Sqrt(2.0), 1.0, 5.0 / Math.Sqrt(2.0)));
                pts.Add(new OpenTK.Vector3d(4.0 / Math.Sqrt(2.0), 1.0, 6.0 / Math.Sqrt(2.0)));

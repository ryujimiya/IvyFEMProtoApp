...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideFirstOrderABCTDProblemb3_0(MainWindow mainWindow)
        {
            double[] freqs;
            System.Numerics.Complex[] freqDomainAmpsInc;
            SolveHWaveguideFirstOrderABCTDProblemb3_0(
                mainWindow, out freqs, out freqDomainAmpsInc);
        }

        // Open Waveguide
        public void SolveHWaveguideFirstOrderABCTDProblemb3_0(

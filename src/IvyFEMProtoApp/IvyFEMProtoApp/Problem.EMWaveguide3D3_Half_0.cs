...
namespace IvyFEMProtoApp
{
    ...
    {
        // straight
        public void EMWaveguide3DProblem3_0(MainWindow mainWindow)
        {
            EMWaveguide3DProblem3_Half_0(mainWindow);
        }

        private void EMWaveguide3DProblem3_Half_0(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            */
            ...
            tmpId = cad.AddVertex(CadElementType.Edge, 18, new OpenTK.Vector3d(x2, y11, z2)).AddVId;
            System.Diagnostics.Debug.Assert(tmpId != 0);
            ...
            {
                IList<uint> innerVIds = new List<uint> { innerVId11, innerVId12, innerVId13 };

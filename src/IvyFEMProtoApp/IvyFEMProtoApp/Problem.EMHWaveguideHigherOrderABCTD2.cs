...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideHigherOrderABCTDProblem2(MainWindow mainWindow)
        {
            // 直線導波路を解く
            double[] freqs;
            ...
            SolveHWaveguideHigherOrderABCTDProblem2(mainWindow, freqDomainAmpsInc);
        }

        public void SolveHWaveguideHigherOrderABCTDProblem2(

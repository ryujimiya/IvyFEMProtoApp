...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguidePMLProblemb2(MainWindow mainWindow)
        {
            ...
            uint[] coreLIds = { 8 };
            uint[] claddingLIds = { 2, 7 };
            uint[] refport1EIds = { 11, 17, 16 };
            uint[] refport1CoreEIds = { 17 };
            uint[] refport1CladdingEIds = { 11, 16 };
            uint[] refport2EIds = { 13 };
            ...
            // スラブ導波路と境界の交点
            {
                double[] portXs = { 0.0, port1PMLPosX, terminalPosX };
                uint[] parentEIds = { 1, 11, 12 };

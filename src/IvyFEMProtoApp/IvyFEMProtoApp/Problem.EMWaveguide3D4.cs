...
namespace IvyFEMProtoApp
{
    ...
    {
        public void EMWaveguide3DProblem4(MainWindow mainWindow, uint feOrder)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            */
            ...
            tmpId = cad.AddVertex(CadElementType.Loop, 11, new OpenTK.Vector3d(x1, y21, z1)).AddVId;
            System.Diagnostics.Debug.Assert(tmpId != 0);

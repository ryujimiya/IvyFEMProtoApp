...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HPlaneWaveguideHigherOrderABCTDProblem1(MainWindow mainWindow)
        {
            // 直線導波路を解く
            IList<double> times;
            ...
            SolveHPlaneWaveguideHigherOrderABCTDProblem1(mainWindow, timeEzsInc);
        }

        public void SolveHPlaneWaveguideHigherOrderABCTDProblem1(MainWindow mainWindow, IList<double> timeEzsInc)
        {
            ...
            */
            ...
            if (timeEzsInc.Count <= timeEzsPort1.Count)
            {
                int cnt = timeEzsPort1.Count - timeEzsInc.Count;
                for (int i = 0; i < cnt; i++)
                {
                    double value = 0.0;
                    timeEzsInc.Add(value);
                }
            }
            else
            {

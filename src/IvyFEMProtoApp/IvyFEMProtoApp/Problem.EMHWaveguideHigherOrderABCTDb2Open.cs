...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideHigherOrderABCTDProblemb2Open(MainWindow mainWindow)
        {
            // 直線導波路を解く
            double[] freqs;
            ...
            SolveHWaveguideHigherOrderABCTDProblemb2Open(mainWindow, freqDomainAmpsInc);
        }

        public void SolveHWaveguideHigherOrderABCTDProblemb2Open(

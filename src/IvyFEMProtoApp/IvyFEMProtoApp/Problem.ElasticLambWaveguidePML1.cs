...
namespace IvyFEMProtoApp
{
    ...
    {
        public void ElasticLambWaveguidePMLProblem1(MainWindow mainWindow)
        {
            ...
            // PML層の厚さ
            //double pmlThickness = 5.0 * unitLen;
            //double pmlThickness = 10.0 * unitLen;
            //double pmlThickness = 30.0 * unitLen;
            double pmlThickness = 10.0 * unitLen;
            // 参照位置
            //double refXDistance = (1.0 / 16.0) * waveguideWidth;
            //double refXDistance = (1.0 / 2.0) * waveguideWidth;
            //double refXDistance = 1.0 * waveguideWidth;
            double refXDistance = (1.0 / 2.0) * waveguideWidth;
            ...
            System.Diagnostics.Debug.Assert(
                (disconLength - 2.0 * pmlThickness - 2.0 * refXDistance) >= crackHalfW * 2.0 * 1.05);
            ...
            uint eIdRef1 = 17;
            uint eIdRef2 = 18;
            //uint eIdSrc = eIdRef1;// 入射面を内部領域にもってくるとNG
            uint eIdSrc = 16;// PMLとの境界
            ...
            Cad2D cad = new Cad2D();
            {
                ...
                uint _lId2 = cad.ConnectVertexLine(3, 15).AddLId;
                uint _lId3 = cad.ConnectVertexLine(4, 14).AddLId;
            ...
            // ux = uy = 0
            {
                var fixedCadDatas = new[]
                {
                    new { CadId = (uint)1, CadElemType = CadElementType.Edge,
                        FixedDofIndexs = new List<uint> { 0, 1 }, Values = new List<System.Numerics.Complex> { 0.0, 0.0 } },

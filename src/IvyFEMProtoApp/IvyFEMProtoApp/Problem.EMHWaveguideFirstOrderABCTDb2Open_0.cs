...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideFirstOrderABCTDProblemb2Open_0(MainWindow mainWindow)
        {
            double[] freqs;
            System.Numerics.Complex[] freqDomainAmpsInc;
            SolveHWaveguideFirstOrderABCTDProblemb2Open_0(
                mainWindow, out freqs, out freqDomainAmpsInc);
        }

        public void SolveHWaveguideFirstOrderABCTDProblemb2Open_0(
            ...
            out System.Numerics.Complex[] retFreqDomainAmpsInc)
        {
            ...
            // 吸収境界条件の次数
            int[] abcOrders = { 1, 1, 1, 1 };
            // Evanescent Waveの吸収境界条件の次数
            //int[] abcOrdersForEvanescent = { };
            int[] abcOrdersForEvanescent = { 0, 0, 1, 1 };
            // ABCの速度 (-1.0: default)
            //double[] velocitys = { };
            double[] velocitys = {
                -1,
            ...
            uint[] port3EIds = { 2, 3, 4, 5 };
            uint[] port3CladdingEIds = { 2, 3, 4, 5 };
            uint[] port4EIds = { 7, 8, 9, 10 };
            uint[] port4CladdingEIds = { 7, 8, 9, 10 };
            ...
            CadObject2D cad2D = new CadObject2D();
            {
                ...
                uint _lId2 = cad2D.ConnectVertexLine(3, 10).AddLId;
                uint _lId3 = cad2D.ConnectVertexLine(4, 9).AddLId;
                uint _lId4 = cad2D.ConnectVertexLine(5, 8).AddLId;
            ...
            // check
            {
                ...
                uint[][] portCladdingEIdss = { 
                    ...
                    port3CladdingEIds, port4CladdingEIds,
            ...
            */
            ...
            {
                // 上下の境界
                uint[][] portEIdss = { port3EIds, port4EIds };
                uint[][] portCladdingEIdss = { port3CladdingEIds, port4CladdingEIds };
                for (int eIdIndex = 0; eIdIndex <portEIdss.Length; eIdIndex++)
                {
                    uint[] eIds = portEIdss[eIdIndex];
                    IList<uint> portCladdingEIds = portCladdingEIdss[eIdIndex].ToList();
...

            {
                ...
                uint[][] _portEIdss = {
                    port1EIds, port2EIds, port3EIds, port4EIds,
            ...
            */
            ...
            var FEM = new EMWaveguide2DHPlaneFirstOrderABCTDFEM(world);

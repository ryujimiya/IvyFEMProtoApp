...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguidePMLProblemb2_0(MainWindow mainWindow)
        {
            ...
            uint[] pmlLIds1 = { 1, 5, 4 };
            uint[] pmlCoreLIds1 = { 5 };
            uint[] pmlCladdingLIds1 = { 1, 4 };
            uint[] pmlLIds2 = { 3, 9, 8 };
            uint[] pmlCoreLIds2 = { 9 };
            uint[] pmlCladdingLIds2 = { 3, 8 };
            ...
            uint[] coreLIds = { 7 };
            uint[] claddingLIds = { 2, 6 };
            uint[] refport1EIds = { 9, 14, 13 };
            uint[] refport1CoreEIds = { 14 };
            uint[] refport1CladdingEIds = { 9, 13 };
            uint[] refport2EIds = { 10, 16, 15 };
            uint[] refport2CoreEIds = { 16 };
            uint[] refport2CladdingEIds = { 10, 15 };

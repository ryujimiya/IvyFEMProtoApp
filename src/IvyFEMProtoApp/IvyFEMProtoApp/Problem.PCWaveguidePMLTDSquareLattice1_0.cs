...
namespace IvyFEMProtoApp
{
    ...
    {
        public void PCWaveguidePMLTDSquareLatticeProblem1_0(MainWindow mainWindow)
        {
            double[] freqs;
        ...
        public void SolvePCWaveguidePMLTDSquareLatticeProblem1_0(
            ...
            out System.Numerics.Complex[] retFreqDomainAmpsInc)
        {
            ...
            */
            ...
            // 励振位置
            double srcPosXB1 = port1PMLPosX + 1 * unitLen;
            ...
            double[][] portPosXss = { port1PosXs, port2PosXs, srcPosXs };
            ...
            for (int col = 0; col < rodCntAll; col++)
            {
                ...
                else if (centerX >= port1PMLPosX && centerX < srcPosXB1)
                {
                    baseLoopId = 2;
                }
                ...
                else if (centerX >= port2PosXB1 && centerX < port2PMLPosX)
                {
                    baseLoopId = 8;
                }

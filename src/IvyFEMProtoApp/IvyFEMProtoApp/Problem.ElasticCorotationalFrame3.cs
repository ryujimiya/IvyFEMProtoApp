...
namespace IvyFEMProtoApp
{
    ...
    {
        public void CorotationalFrameProblem3(MainWindow mainWindow, bool isTimoshenko)
        {
            double beamLen = 1.0;
        ...
        public void CorotationalFrameTDProblem3(MainWindow mainWindow, bool isTimoshenko)
        {
            double beamLen = 1.0;
            double b = 0.2 * beamLen;
            double h = 0.25 * b;

...
namespace IvyFEMProtoApp
{
    ...
    {
        public void ElasticTwoBodyContact3DProblem1(MainWindow mainWindow, bool isStVenant)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            Cad3D cad = new Cad3D();
            {
                ...
                pts.Add(new OpenTK.Vector3d(-1.0, -3.0, 0.0));
                pts.Add(new OpenTK.Vector3d(1.0, -3.0, 0.0));
                pts.Add(new OpenTK.Vector3d(1.0, 3.0, 0.0));
                pts.Add(new OpenTK.Vector3d(-1.0, 3.0, 0.0));
                pts.Add(new OpenTK.Vector3d(-1.0, -3.0, 2.0));
                pts.Add(new OpenTK.Vector3d(1.0, -3.0, 2.0));
                pts.Add(new OpenTK.Vector3d(1.0, 3.0, 2.0));
                pts.Add(new OpenTK.Vector3d(-1.0, 3.0, 2.0));
            ...
            }
            {
                ...
                pts.Add(new OpenTK.Vector3d(3.0, 3.0, -2.0));
                pts.Add(new OpenTK.Vector3d(-3.0, 3.0, -2.0));
                pts.Add(new OpenTK.Vector3d(-3.0, -3.0, -1.0));
                pts.Add(new OpenTK.Vector3d(3.0, -3.0, -1.0));
                pts.Add(new OpenTK.Vector3d(3.0, 3.0, -1.0));
                pts.Add(new OpenTK.Vector3d(-3.0, 3.0, -1.0));
                var res = cad.AddCube(pts);
            ...
            for (int iTime = 0; iTime <= 50; iTime++)
            {
                ...
                fixedValueXYZ[0] = 0;
                fixedValueXYZ[1] = 0;
                fixedValueXYZ[2] = -1.75 * Math.Sin(t * 2.0 * Math.PI * 0.1);

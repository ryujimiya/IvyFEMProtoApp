...
namespace IvyFEMProtoApp
{
    ...
    {
        public void MITCMooneyRivlinPlateProblem2(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            */
...

            {
                ...
                uint maId = 0;
                {
                    var ma = new MITCMooneyRivlinPlateMaterial();
            ...
            for (int iTime = 0; iTime <= timeCnt; iTime++)
            {
                ...
                if (iTime == (timeCnt / 2))
                {
                    FEM.TimeIndexForInit = 0; // 初期化処理を再度施す
                }

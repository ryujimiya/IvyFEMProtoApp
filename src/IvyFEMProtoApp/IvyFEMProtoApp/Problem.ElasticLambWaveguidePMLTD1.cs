...
namespace IvyFEMProtoApp
{
    ...
    {
        public void ElasticLambWaveguidePMLTDProblem1(MainWindow mainWindow)
        {
            // 直線導波路を解く
            double[] freqs;
            ...
            SolveElasticLambWaveguidePMLTDProblem1(mainWindow, freqDomainAmpsInc);
        }

        public void SolveElasticLambWaveguidePMLTDProblem1(
            MainWindow mainWindow, System.Numerics.Complex[] freqDomainAmpsInc)
        {
            ...
            System.Diagnostics.Debug.Assert(
                (disconLength - pmlThicknessX1 - pmlThicknessX2 - 2.0 * refXDistance) >= crackHalfW * 2.0 * 1.05);
            ...
            int portCnt;
            {
                ...
                for (int portId = 0; portId < eIds.Length; portId++)
                {
                    ...
                    PortCondition portCondition = new ConstPortCondition(
                        portEIds, CadElementType.Edge, FieldValueType.Vector2,

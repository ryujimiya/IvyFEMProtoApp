...
namespace IvyFEMProtoApp
{
    ...
    {
        public void FrameProblem(MainWindow mainWindow)
        {
            double beamLen = 1.0;
            double groundY = -1.0;
            int beamCntX = 2;
            ...
            CadObject2D cad = new CadObject2D();
            {
                ...
                uint vId7 = cad.AddVertex(CadElementType.Loop, lId0, new OpenTK.Vector2d(0.0, groundY)).AddVId;
                uint vId8 = cad.AddVertex(CadElementType.Loop, lId0, new OpenTK.Vector2d(beamsLen, groundY)).AddVId;
                ...
                uint eId9 = cad.ConnectVertexLine(vId7, vId1).AddEId;
                uint eId10 = cad.ConnectVertexLine(vId8, vId4).AddEId;
            }
        ...
        public void FrameTDProblem(MainWindow mainWindow)
        {
            double beamLen = 1.0;
            double groundY = -1.0;
            int beamCntX = 2;

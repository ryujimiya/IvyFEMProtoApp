...
namespace IvyFEMProtoApp
{
    partial class Problem
    {
        // Open Waveguide
        // 参照面、励振面を境界と一致させる
        public void HWaveguideHigherOrderABCProblemb3_0(MainWindow mainWindow)
        {
            ...
            uint loopCnt = 3;
            uint[] coreLIds = { 3 };
            uint[] claddingLIds = { 1, 2 };
            uint[] port1EIds = { 1, 6, 5 };
            uint[] port1CoreEIds = { 6 };
            uint[] port1CladdingEIds = { 1, 5 };
            uint[] port2EIds = { 3, 8, 7 };
            uint[] port2CoreEIds = { 8 };
            uint[] port2CladdingEIds = { 3, 7 };
            uint[] port3EIds = { 2 };
            uint[] port3CladdingEIds = { 2 };
            uint[] port4EIds = { 4 };
            uint[] port4CladdingEIds = { 4 };
            ...
            {
                // 入出力面と参照面、励振面
                double[] portXs = { 0.0, disconLength };
                uint[] parentEIds = { 1, 3 };

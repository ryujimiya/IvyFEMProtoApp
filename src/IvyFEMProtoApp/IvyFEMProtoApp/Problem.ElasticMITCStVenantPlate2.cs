...
namespace IvyFEMProtoApp
{
    ...
    {
        public void MITCStVenantPlateProblem2(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            */
...

            {
                ...
                uint maId = 0;
                {
                    var ma = new MITCStVenantPlateMaterial();
            ...
            uint[] additionalValueIds = new uint[] { uValueId, vnValueId, v1ValueId, v2ValueId };
        ...
        public void MITCStVenantPlateTDProblem2(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            var camera3D = mainWindow.Camera as Camera3D;

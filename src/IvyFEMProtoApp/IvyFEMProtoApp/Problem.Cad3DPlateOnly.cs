...
namespace IvyFEMProtoApp
{
    ...
    {
        public void MakeCad3DPlateOnly(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
        ...
        public void MakeCoarseMesh3DPlateOnly(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            var camera3D = mainWindow.Camera as Camera3D;
        ...
        public void MakeMesh3DPlateOnly(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            var camera3D = mainWindow.Camera as Camera3D;

...
namespace IvyFEMProtoApp
{
    ...
    {
        public void PCWaveguideEigenTriangleLatticeProblem1(MainWindow mainWindow)
        {
            ...
            double minWaveNum = 0.5;
            // 考慮する波数ベクトルの最大値
            //double maxWaveNum = 0.5;
            double maxWaveNum = 1.0;
            */
            // 考慮する波数ベクトルの最小値
            double minWaveNum = 0.0;
            // 考慮する波数ベクトルの最大値
            ...
            double normalizedFreq1 = 0.250;
            double normalizedFreq2 = 0.340;

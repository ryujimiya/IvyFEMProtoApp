...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideHigherOrderABCTDProblemb1(MainWindow mainWindow)
        {
            // 直線導波路を解く
            double[] freqs;
            ...
            SolveHWaveguideHigherOrderABCTDProblemb1(mainWindow, freqDomainAmpsInc);
        }

        public void SolveHWaveguideHigherOrderABCTDProblemb1(
            MainWindow mainWindow, System.Numerics.Complex[] freqDomainAmpsInc)
        {
            ...
            CadObject2D cad2D = new CadObject2D();
            {
                ...
                uint _lId4 = cad2D.ConnectVertexLine(6, 9).AddLId;
            }
            ...
            */
            ...
            uint[] zeroEIds = { 2, 3, 4, 5, 6, 8, 9, 10, 11, 12 };

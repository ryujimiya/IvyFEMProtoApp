...
namespace IvyFEMProtoApp
{
    ...
    {
        public void Waveguide2DEigenOpenProblem2(MainWindow mainWindow, uint feOrder)
        {
            double waveguideWidth = 1.0;
            //double waveguideHeight = (3.0 / 4.0) * waveguideWidth;
            double waveguideHeight = (2.0 / 4.0) * waveguideWidth;
            double boardHeight = (1.0 / 4.0) * waveguideWidth;
            double stripWidth = 2.0 * boardHeight;
            double boardEp = 2.55;
            double vacuumEp = 1.0;
            double maxEp = boardEp * 1.00;
            // 磁界？ default: false
            // false: 電界
            // true: 磁界
            ...
            double eFreq = 1.0;
            int freqDiv = 50;
            //double sFreq = 0.5; //DEBUG
            //double eFreq = 1.0; //DEBUG
            //int freqDiv = 1; // DEBUG
            ...
            */
            ...
            uint boardMaId;
            {
                ...
                // 外側境界
                uint[] bcEIds = { 1, 2, 4, 5, 6 };
                uint[] bcMaIds = {
                    vacuumMaId, boardMaId, boardMaId, vacuumMaId, vacuumMaId
                };
            ...
            double[] portEp = new double[5] {
                vacuumEp, boardEp, boardEp, vacuumEp, vacuumEp
            };

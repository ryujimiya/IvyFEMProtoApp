...
{
    unsafe struct NativeLisCommTable
    {
        private int comm;
        private int pad;
    ...
    unsafe struct NativeLisMatrixCore
    {
        private int nnz;
        private int ndz;
        private int bnr;
    ...
    unsafe struct NativeLisMatrixDiag
    {
        private int label;
        private int status;
        private int precision;
    ...
    unsafe struct NativeLisMatrixILU
    {
        private int n;
        private int bs;
        private int* nnz_ma;

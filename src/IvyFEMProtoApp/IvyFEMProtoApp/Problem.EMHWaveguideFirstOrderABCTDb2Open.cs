...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideFirstOrderABCTDProblemb2Open(MainWindow mainWindow)
        {
            // 直線導波路を解く
            double[] freqs;
            ...
            SolveHWaveguideFirstOrderABCTDProblemb2Open(mainWindow, freqDomainAmpsInc);
        }

        public void SolveHWaveguideFirstOrderABCTDProblemb2Open(

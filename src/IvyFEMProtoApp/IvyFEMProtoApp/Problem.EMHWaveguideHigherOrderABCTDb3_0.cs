...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideHigherOrderABCTDProblemb3_0(MainWindow mainWindow)
        {
            double[] freqs;
            System.Numerics.Complex[] freqDomainAmpsInc;
            SolveHWaveguideHigherOrderABCTDProblemb3_0(
                mainWindow, out freqs, out freqDomainAmpsInc);
        }

        // Open Waveguide
        public void SolveHWaveguideHigherOrderABCTDProblemb3_0(

...
namespace IvyFEMProtoApp
{
    ...
    {
        public void HWaveguideHigherOrderABCTDProblemb2Open_0(MainWindow mainWindow)
        {
            double[] freqs;
            System.Numerics.Complex[] freqDomainAmpsInc;
            SolveHWaveguideHigherOrderABCTDProblemb2Open_0(
                mainWindow, out freqs, out freqDomainAmpsInc);
        }

        public void SolveHWaveguideHigherOrderABCTDProblemb2Open_0(

...
namespace IvyFEMProtoApp
{
    ...
    {
        public void EMWaveguide3DProblem1(MainWindow mainWindow)
        {
            /////////////////////
            Dimension = 3; // 3次元
            ...
            double wc1 = 0.8 / 2.0;
            double pos1X = (disconLength - wc1) / 2.0;
            double pos1Y = wa1;
            ...
            cad.AddRectLoop(1, new OpenTK.Vector2d(pos1X, pos1Y), new OpenTK.Vector2d(pos2X, pos2Y));
            cad.LiftLoop(7, cad.GetLoop(7).Normal * (+wb1));
            {
            ...
            */
            ...
            uint[] scalarZeroLIds = { 1, 2, 4, 6, 12 };
